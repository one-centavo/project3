...
<div
    class="min-h-screen bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] p-4 sm:p-6 lg:p-8 transition-colors duration-300">
    <div class="max-w-7xl mx-auto space-y-8">

        <!-- Dashboard Header -->
        <div
            class="flex flex-col md:flex-row md:items-center md:justify-between border-b border-gray-100 dark:border-[#3E3E3A] pb-6 gap-4">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-[#1b1b18] dark:text-[#EDEDEC]">Sync Manager</h1>
                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">Gestión de clientes sincronizados y fuera de línea
                </p>
            </div>
            ...
            window.addEventListener('offline', () => isOnline = false);" class="flex items-center">
                ...
                <template x-if="!isOnline">
                    <span
                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-400 border border-amber-200 dark:border-amber-900/50">
