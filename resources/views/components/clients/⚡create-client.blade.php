...
<div x-data="{
    ...
    <div class="bg-white dark:bg-[#161615] rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.05),inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[0px_4px_20px_rgba(0,0,0,0.15),inset_0px_0px_0px_1px_#fffaed2d] p-6 lg:p-8 transition-all duration-300">
        ...
        <div class="flex items-center space-x-3 mb-6 border-b border-gray-100 dark:border-[#3E3E3A] pb-4">
            <div class="p-2 bg-[#fff2f2] dark:bg-[#1D0002] rounded-lg text-[#f53003] dark:text-[#FF4433] transition-colors">
        ...
        <template x-if="successMessage">
            <div class="mb-5 flex items-center p-4 text-sm text-green-800 dark:text-green-300 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-100 dark:border-green-900 transition-all duration-300" role="alert">
        ...
        <template x-if="errorMessage">
            <div class="mb-5 flex items-center p-4 text-sm text-red-800 dark:text-red-300 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-100 dark:border-red-900 transition-all duration-300" role="alert">
                <svg class="flex-shrink-0 inline w-4 h-4 mr-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <form @submit.prevent="submitForm" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="dni" x-model="dni" 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="first_name" x-model="first_name" 
                        placeholder="John" 
                        class="w-full px-3.5 py-2 text-sm rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#161615] text-[#1b1b18] dark:text-[#EDEDEC] focus:border-[#f53003] dark:focus:border-[#FF4433] focus:ring-1 focus:ring-[#f53003] focus:outline-none transition-all duration-200"
                        required>
                </div>
                <div>
                    <label for="second_name" class="block mb-1.5 text-xs font-semibold text-gray-700 dark:text-gray-300">
                        Second Name <span class="text-gray-400 dark:text-gray-500 font-normal">(Optional)</span>
                    </label>
                    <input type="text" id="second_name" x-model="second_name" 
                        placeholder="Edward" 
                        class="w-full px-3.5 py-2 text-sm rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#161615] text-[#1b1b18] dark:text-[#EDEDEC] focus:border-[#f53003] dark:focus:border-[#FF4433] focus:ring-1 focus:ring-[#f53003] focus:outline-none transition-all duration-200">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="first_last_name" class="block mb-1.5 text-xs font-semibold text-gray-700 dark:text-gray-300">
                        First Last Name <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="first_last_name" x-model="first_last_name" 
                        placeholder="Doe" 
                        class="w-full px-3.5 py-2 text-sm rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#161615] text-[#1b1b18] dark:text-[#EDEDEC] focus:border-[#f53003] dark:focus:border-[#FF4433] focus:ring-1 focus:ring-[#f53003] focus:outline-none transition-all duration-200"
                        required>
                </div>
                <div>
                    <label for="second_last_name" class="block mb-1.5 text-xs font-semibold text-gray-700 dark:text-gray-300">
                        Second Last Name <span class="text-gray-400 dark:text-gray-500 font-normal">(Optional)</span>
                    </label>
                    <input type="text" id="second_last_name" x-model="second_last_name" 
                        placeholder="Smith" 
                        class="w-full px-3.5 py-2 text-sm rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#161615] text-[#1b1b18] dark:text-[#EDEDEC] focus:border-[#f53003] dark:focus:border-[#FF4433] focus:ring-1 focus:ring-[#f53003] focus:outline-none transition-all duration-200">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="phone_number" class="block mb-1.5 text-xs font-semibold text-gray-700 dark:text-gray-300">
                        Phone Number <span class="text-red-500">*</span>
                    </label>
                    <input type="tel" id="phone_number" x-model="phone_number" 
